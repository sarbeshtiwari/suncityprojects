...
async function GET() {
    try {
        ...
        const locations = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Location$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).select('name city state country createdAt updatedAt').sort({
            name: 1
        });
...
async function POST(request) {
    try {
        ...
        if (!name || !city || !state || !country) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'All fields (name, city, state, country) are required'
            }, {
                status: 400
            });
        }
        // Check if location already exists
        const existingLocation = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Location$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            name: {
        ...
        if (existingLocation) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Location with this name and city already exists'
            }, {
                status: 409
            });
        }
        // Create new location
        const newLocation = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Location$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            name,
            city,
            state,
            country
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d586c64._.js.map